...
with st.sidebar:
    ...
    st.info("Dapatkan key gratis di Google AI Studio (aistudio.google.com)")
...
if submitted:
    if not api_key:
        st.error("⚠️ Tolong masukkan API Key di sidebar kiri terlebih dahulu!")
    elif not copywriting or not team_name:
